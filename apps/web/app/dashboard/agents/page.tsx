...
export default async function AgentsPage() {
  ...
  if (!orgId) {
    return (
      <div>
        <h1 className="text-2xl font-bold text-gray-100 mb-2">AI Workforce</h1>
        <div className="rounded-lg border border-yellow-800 bg-yellow-900/20 p-4 text-yellow-300 text-sm">
          Create or select an organization to view agents.
        </div>
      </div>
    );
  }
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-gray-100 mb-1">AI Workforce</h1>
